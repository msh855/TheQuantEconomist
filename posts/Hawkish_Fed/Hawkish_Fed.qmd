...
In the world of central banking few tools have gathered as much attention in recent years as forward guidance - the method central banks are using to directly communicate or signal their intentions to shape expectations and influence interest rates in the desired direction. During the 2008 financial crisis, forward guidance became an especially critical tool, as the policy rate hit zero. In order to continue to stimulate the economy, the Fed needed to find new tricks or, in the words of [Bernanke](https://www.amazon.co.uk/21st-Century-Monetary-Policy-Inflation/dp/1324020466/ref=sr_1_1?adgrpid=1172080352962224&hvadid=73255235197595&hvbmt=be&hvdev=c&hvlocphy=4923&hvnetw=o&hvqmt=e&hvtargid=kwd-73255197392577%3Aloc-188&hydadcr=18495_2211395&keywords=21st+century+monetary+policy&qid=1681764141&sr=8-1), \`\`we had to be creative". Forward guidance allowed it to do just that. More recently, forward guidance has played an important role in the ongoing debate over inflation. In this post, I will be looking at a few stylized facts about how the Fed uses this tool.
...
I plot these two rates in @fig-1. The discrepancy between them shows the level of forward guidance measured as an interest rate. It is worth noting that due to the way monetary policy is conducted (i.e. usually first preparing the markets and then acting) the proxy rate leads the actual policy rate, and this pattern (not surprisingly) is especially pronounced post-2007.

Before the global financial crisis, the proxy rate and the fund rate were tightly correlated, until they started to diverge after 2007, when both QE and forward guidance became integral components of the monetary policy framework. During this period, the use of forward guidance amounted to a monetary policy stance of negative interest rates (validating the purpose that it was designed). These ultra-low interest rates persisted until 2014, when the Fed started to actually reversing its course according to the proxy rate.

## Did the Fed acted with a delay?

In the more recent years, much of the analysis (including that of respected [academics](https://www.lse.ac.uk/CFM/assets/pdf/CFM-Discussion-Papers-2022/CFMDP2022-09-Paper.pdf)) has rushed to the conclusion that the Fed acted with a delay. However, as @fig-1 clearly shows, the Fed began to tighten financial conditions through forward guidance well before the interest rate hikes took place. According to the proxy rate, the actual tightening began a full eight months prior to the first rate hike in March 2022 and almost a year and a half after the pandemic shock and at a time when inflation was [mostly driven by supply side factors](https://www.frbsf.org/economic-research/indicators-data/supply-and-demand-driven-pce-inflation/) - and hence there was less room for monetary policy to do much. 
