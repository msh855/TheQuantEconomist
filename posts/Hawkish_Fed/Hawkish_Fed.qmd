...
[^2]: TO filter out I just controlled for the change in 10 YT Treasury as proxy. This of course does not necessary remove the impact of balance sheet changes by signalling chancels. There are many findings that suggest that only the first round of QE was strong enough. Subsequent round became less effective as markets learned to anticipate Fed's balance sheets. It is also the reason, why Bernanke was arguing for more QE to offset this factor as well as to compensate for the tight Fiscal policy at the time. 
