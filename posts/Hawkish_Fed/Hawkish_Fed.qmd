...
All in all, this evidence now makes it clear that the inclusion of forward guidance and other unconventional tools has broadened the criteria by which the monetary policy stance needs to be assessed. It is now clear that the Fed has become looser than it appears when stimulating the economy, and tighter than the policy rate indicates when tightening. As a result, it is becoming more important to get a better sense of and measure the non-conventional aspects of monetary policy. The next paragraphs will examine this issue more closely.
...
Fed's tone shift was mostly evident in Jay Powell's Jackson Hole who declared ``the Federal Reserve must keep at it until the job is done”. The US stock market slid sharply after Powell spoke, with the benchmark S&P 500 index falling 3.4 per cent, while the tech-heavy Nasdaq Composite tumbled 3.9 per cent, recording the biggest one-day decline for both indices (outside sudden crashes).
...
Does this mean that a [soft landing](https://www.investopedia.com/terms/s/softlanding.asp) is off the table? That's a whole other discussion. But the short answer is "No." In fact, the opposite is true. According to this evidence, the Fed's actions are what kept a soft landing on the table.


Technically, only the Fed needs to comply to a soft landing because of its mandate to balance maximum employment and price stability. Other central banks don't have this restriction[^3]. Yet soft landing is still the holy grail of central banking. [R. Dornbusch](https://en.wikipedia.org/wiki/Rudi_Dornbusch) famously said, "*No postwar recovery has died in bed of old age---the Federal Reserve has murdered every one of them*". The most notable (and technically the only) soft landing in the most recent 16 business cycles occurred in 1994 under Alan Greenspan. Inflation was rising rapidly in 1994, and Greenspan raised interest rates seven times in the space of a year, bringing them up to 6%. This was a significant increase, but it did not cause a recession. In fact, the economy continued to grow throughout 1994 and 1995. Why was it successful? Economists will pick three main reasons:
...
In @fig-5, I plotted this episode and compared it to the current tightening cycle. I also added the "Hard landing" of Volcker (which was essentially started by Burns and Miller) and the in-between tightening cycle of 1999 to make the case clearer. Before the 1980s, any comparisons are meaningless (the Gold Standard, substantially different monetary policy framework, fiscal dominance). 
...
The three conditions I listed before continue to hold. The Fed's reaction function under Greenspan and now is quite similar, including making up for Friedman's "long and variable lags." 

In my judgment, though, the luck factors may be more important then the past. I call "luck factors" the factors that central banks cannot fully control, such as consumer and business behavior. These behaviors are generally stable and predictable, but they can be disrupted by indirect or second-round effects of monetary policy. For example, when interest rates rise, mortgage payments become more expensive, which reduces disposable income. This can lead to slower growth, which in turn can further reduce disposable income. These indirect effects is what makes the effects of monetary policy to have "long and variable lags". Supply shocks are also "luck factors", as are any other unanticipated events. 

In addition, soft landing substantially depends on the preference around the *pace* that central banks want to bring inflation down. A fast pace, implies less chance for a soft-landing as it requires the real economy to be crashed. Too slow also reduce the chance for soft landing, as there is high chance inflation expectations to get de-anchored and new unfavorable shocks hit the system. So, soft landing is and remains a fine-tuning exercise difficult to achieve. In the current situation, the Fed is still implicitly that the Philips curve is relatively flat and that the pace of extensive margins charged by firms will slow down due to falling prices and the complete normalization of supply chains. All-in-all, soft landing remains (and ultimately is) a fine tuning exercise that is difficult to achieve - almost identical if not as elusive as timing the market. Based on the evidence here I do think the Fed took all necessary steps to achieve this goal and some of the necessary conditions for soft landing are clearly met. 
