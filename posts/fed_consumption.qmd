...
> - *Monetary policy tightness is relevant for inflation dynamics. But how tight the monetary policy stance is, depends on the transmission of interest rates to consumer spending, the largest component of aggregate demand. In this post, I provide an illustrative analysis of how sensitive consumption is to changes in interest rates according to the Fed's recent projections*. 
...
> - *Fed’s assumptions are not implausible. However, the great majority of the empirical evidence is strongly against it. Consumption might prove less responsive than the Fed expects because rich households (net savers) benefit from higher interest income. In this situation, higher interest rate hikes might not necessarily bring inflation down as fast as the Fed wants.*

> - *Overall, even if the aggregate effects of monetary policy are probably about as large as we want, I discuss here why monetary policy works largely through redistribution. For that reason, if inflation does not normalise as quickly as the Fed hopes it is questionable whether it will insist on any excessive tightening*. 
...
In this section, I estimate the EIS based on Fed’s forecasts. To this end, I will use a conventional macroeconomic approach. This might not allow definite conclusions but works well as a proof of concept. Assuming that households are reasonably forward-looking, conventional macroeconomic theory likes to use the so-called Euler Equation to study consumption dynamics. People might also recognise this through the CAMP model used for studying the relationship between business cycles and asset prices.
...
My post didn't aim to provide a comprehensive analysis here. To fix ideas, I only focused on consumption-saving choices taking into account the desire of consumers to smooth consumption over-time. At times of heightened uncertainty, however, precautionary savings is another motive households might develop to insure themselves against uncertain labour market prospects. This extra savings combined with pessimistic sentiment also contribute to a falling aggregate demand. So, even if the Fed gets it wrong on how sensitive consumption to higher interest rates, uncertainty is on her side. Spreading the fear of recession is all it takes to have aggregate demand (and oil prices) falling.

Overall, however, it appears that are the luck factors that would determine the inflation dynamics as neither the supply side factor nor the indirect effects are in Fed's direct control.

[^1]: Risk aversion and EIS are not separable here. For asset pricing and studying the behaviour of equity premia is important to seperate the two. There is a large body of literature that uses the so called [Epstein-Zin preferences](https://www.wikiwand.com/en/Epstein%E2%80%93Zin_preferences) for this purpose.

[^2]: This also implies that the demand for mortages will also drop. So, house prices might be under real pressure considering the banking sector will cut lending.