...
subtitle: "*Has inflation changed regime?*"
date: "09/21/2021"
categories:
  - Machine learning
  - Inflation  
...
> *In this post I show how to use a basic clustering algorithm to identify different inflation regimes across time. I am comparing the regimes for both headline and core inflation. At the time of writing, core inflation did not change regime unlike the headline inflation, which includes food and oil prices. This signals that supply side factors might be driving inflation dynamics, hence it is quite likely that core inflation might change regime too.*
